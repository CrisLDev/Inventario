    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" onsubmit="disable()" id="form-prevent-multiple-submits" action="{{ route('login') }}">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-8 offset-md-4">
                                <button type="submit" id="button-prevent-multiple-submits" class="btn btn-primary">
                                    <span class="spinner-border spinner-border-sm" id="spinner" role="status" aria-hidden="true"></span>    
                                    <span id="btex"><i class="fas fa-sign-in-alt"></i> {{ __('Login') }}</span>
                                </button>
